...
class PesaPal(object):
    ...
    def postDirectOrder(self, params, request_data):
        ...
        default_params = {
            ...
            #'oauth_timestamp': '',
            #'oauth_version': '1.0',
            'pesapal_request_data': escape(pesapal_request_data)
        }

        http_url = 'https://www.pesapal.com/api/PostPesapalDirectOrderV4'
    ...
    def queryPaymentStatus(self, params):
        ...
        """
        http_url = 'https://www.pesapal.com/API/QueryPaymentStatus'
    ...
    def queryPaymentStatusByMerchantRef(self, params):
        ...
        http_url = 'https://www.pesapal.com/API/QueryPaymentStatusByMerchantRef'
